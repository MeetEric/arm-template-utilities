...
# ORIGINAL SOURCE - https://gist.githubusercontent.com/trentmswanson/9c22bb71182e982bd36f/raw/27d9a545e07713d9352bf6140841ae12b42dea12/autopart.sh
...
get_next_mountpoint() {
    DIRS=($(ls -1d ${DATA_BASE}/disk* 2>&1| sort --version-sort))
    if [ -z "${DIRS[0]}" ];
    then
